...
export const Q6 = [
  ...
  externalForFamily: "確認時、普段と比べて反応が弱い状態でした",
  },
  {
    id: "q2",
  ...
  externalForFamily: "確認時、呼吸が普段と異なる様子でした",
  },
  {
    id: "q3",
  ...
  externalForFamily: "確認時、突然の強い症状を訴えていました",
  },
  {
    id: "q4",
  ...
  externalForFamily: "確認時、昨日までと比べて急な変化がありました",
  },
  {
    id: "q5",
  ...
  externalForFamily: "確認時、出血が止まらない状態でした",
  },
  {
    id: "q6",
  ...
  externalForFamily: "確認時、強い混乱が見られました",
  },
];
...
export const SLEEP = [
  ...
  { id: "s2", text: "胸やお腹が、呼吸に合わせて一定のリズムで動いていますか？（見える範囲でOK／分からなければ『不明』）" },
